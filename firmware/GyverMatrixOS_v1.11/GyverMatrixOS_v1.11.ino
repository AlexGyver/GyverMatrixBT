...
#define BT_MODE 0             // использовать управление по блютус (0 нет, 1 да)
...
boolean gameFlag;                  // текущий режим в ручном режиме - игра
...
// #define public
  ...
  long timeZoneOffset = 7L;            // set this to the offset in seconds to your local time;
  long daylight = 1;
  long ntp_t = 0;
  byte init_time = 0;

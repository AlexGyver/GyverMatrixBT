typedef uint16_t frame_line_t[16];
typedef frame_line_t frame_t[16];
 
const frame_t frame00 PROGMEM = {
...
const frame_t* framesArray[] = {&frame00, &frame01, &frame02, &frame03};
...
void loadImage(const frame_t* frame) {

...
#define BT_MODE 1           // использовать управление по блютус (0 нет, 1 да) - СИЛЬНО ЖРЁТ ПАМЯТЬ!!!
...
byte CLOCK_X = 1, CLOCK_Y = 6; // Для часов на матрице 16х16 горизонтальных - 1,6; для вертикальных - 5,3

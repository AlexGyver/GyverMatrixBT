...
/*
  ...
  удерж верх - яркость +
  удерж низ - яркость -
  удерж право - скорость +
  удерж лево - скорость -

  кнопка set при активной игре - переход в режим игры
  давно не нажимал кнопки управления - игра перешла в демо режим
  удержал кнопку запуска игры - лабиринт включился в режим 2
*/
